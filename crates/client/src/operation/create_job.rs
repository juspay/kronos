...
/// Orchestration and serialization glue logic for `CreateJob`.
...
impl CreateJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_job::CreateJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_job::CreateJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_job::CreateJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_job::CreateJobOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) async fn orchestrate_with_stop_point(
                        ...
                        .instrument(::tracing::debug_span!(
                                "KronosService.CreateJob",
                                "rpc.service" = "KronosService",
                                "rpc.method" = "CreateJob",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateJobResponseDeserializer));
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateJob")
                            .with_interceptor(::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default())
.with_interceptor(CreateJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_job::CreateJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_job::CreateJobError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_job::de_create_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_job::de_create_job_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_job::CreateJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_job::CreateJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v1/jobs").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_job::ser_create_job_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateJobEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateJobInput>()
                        .ok_or("failed to downcast to CreateJobInput")?;
...
pub enum CreateJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateJobError) for what information is available for the error.")]
...
impl CreateJobError {
    /// Creates the `CreateJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateJobError::InvalidRequestError`.
    pub fn is_invalid_request_error(&self) -> bool {
        matches!(self, Self::InvalidRequestError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::ConflictError`.
    pub fn is_conflict_error(&self) -> bool {
        matches!(self, Self::ConflictError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::NotFoundError`.
    pub fn is_not_found_error(&self) -> bool {
        matches!(self, Self::NotFoundError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::UnprocessableEntityError`.
    pub fn is_unprocessable_entity_error(&self) -> bool {
        matches!(self, Self::UnprocessableEntityError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::UnauthorizedError`.
    pub fn is_unauthorized_error(&self) -> bool {
        matches!(self, Self::UnauthorizedError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::InternalError`.
    pub fn is_internal_error(&self) -> bool {
        matches!(self, Self::InternalError(_))
    }
    /// Returns `true` if the error kind is `CreateJobError::RateLimitedError`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateJobError {
