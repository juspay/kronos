...
/// Configuration for a kronos_sdk service client.
/// 
...
impl Builder {
    ...
    /// Sets the HTTP client to use when making requests.
                            ...
                            /// # fn example() {
                            /// use std::time::Duration;
                            /// use kronos_sdk::config::{Builder, Config};
                            /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
                            ///
                            ...
                            /// }
                            ///
                            /// let mut builder = kronos_sdk::Config::builder();
    ...
    /// Sets the login that will be used for HTTP basic auth.
                                pub fn basic_auth_login(self, basic_auth_login: crate::config::Login) -> Self {
                                    self.basic_auth_login_resolver(basic_auth_login)
                                }
    
                                /// Sets a login resolver that will be used for HTTP basic auth.
                                pub fn basic_auth_login_resolver(mut self, basic_auth_resolver: impl crate::config::ResolveIdentity + 'static) -> Self {
                                    self.runtime_components.set_identity_resolver(
                                        ::aws_smithy_runtime_api::client::auth::http::HTTP_BASIC_AUTH_SCHEME_ID,
                                        ::aws_smithy_runtime_api::shared::IntoShared::<::aws_smithy_runtime_api::client::identity::SharedIdentityResolver>::into_shared(basic_auth_resolver)
                                    );
                                    self
                                }
    ...
    /// Sets the endpoint resolver to use when making requests.
                            ...
                            /// ```no_run
                            /// use kronos_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
                            /// #[derive(Debug)]
                            ...
                            /// let config = kronos_sdk::Config::builder().endpoint_resolver(resolver).build();
    ...
    /// Set the retry_config for the builder
                            ...
                            /// ```no_run
                            /// use kronos_sdk::config::Config;
                            /// use kronos_sdk::config::retry::RetryConfig;
                            ///
    ...
    /// Set the sleep_impl for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use kronos_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use kronos_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Set the timeout_config for the builder
                            ...
                            /// # use std::time::Duration;
                            /// use kronos_sdk::config::Config;
                            /// use kronos_sdk::config::timeout::TimeoutConfig;
                            ///
    ...
    /// Set the identity cache for auth.
                            ...
                            /// ```no_run
                            /// use kronos_sdk::config::IdentityCache;
                            ///
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("kronos_sdk::config::Config").freeze(),
                                    cloneable: layer,
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    ...
                    runtime_components.push_auth_scheme(::aws_smithy_runtime_api::client::auth::SharedAuthScheme::new(::aws_smithy_runtime::client::auth::http::BasicAuthScheme::new()));
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("kronos_sdk::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    if config.behavior_version.is_none() {
                    ...
                    let default_retry_partition = "kronosservice";
                    

                    let scope = "kronos_sdk";
...
pub use ::aws_smithy_runtime_api::client::identity::http::Login;
