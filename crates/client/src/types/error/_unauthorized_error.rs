...
impl UnauthorizedErrorBuilder {
    ...
    /// - [`error`](crate::types::error::builders::UnauthorizedErrorBuilder::error)
    pub fn build(self) -> ::std::result::Result<crate::types::error::UnauthorizedError, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::error::UnauthorizedError {
                error: self.error
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error", "error was not specified but it is required when building UnauthorizedError")
                    )?
                ,
